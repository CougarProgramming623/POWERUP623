...
std::shared_ptr<WPI_TalonSRX> RobotMap::intakeController;
...
void RobotMap::init() {
	...
	liftController.reset(new WPI_TalonSRX(17));
	...
	intakeController.reset(new WPI_TalonSRX(18));
	pot.reset(new AnalogPotentiometer(analogInput, 10.0, 0.0));

	RobotMap::driveTrainleftBack->ConfigSelectedFeedbackSensor(
			FeedbackDevice::QuadEncoder, 0, 5);

	RobotMap::driveTrainrightBack->ConfigSelectedFeedbackSensor(FeedbackDevice::QuadEncoder, 0, 5);

	RobotMap::driveTrainrightBack->ConfigSelectedFeedbackSensor(FeedbackDevice::QuadEncoder, 1, 5);
