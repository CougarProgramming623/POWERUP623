...
//0.73417 top ~ 0.735
//
#define ELEVATOR_BOTTOM .109 //.025
#define ELEVATOR_DELTA 0.665
#define ELEVATOR_TOP ELEVATOR_DELTA + ELEVATOR_BOTTOM //0.827
#define ELEVATOR_SWITCH ELEVATOR_BOTTOM + 0.20 + .05
